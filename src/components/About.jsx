...
const About = () => {
  ...
  return (
    <section ref={ref} id="about">
      <div className="w-full justify-center bg-slate-950 overflow-hidden">
        <motion.div style={{ y: paralaxText }} className="pt-40 pb-30 z-0">
          <h1 className="text-slate-100 font-light text-3xl text-center font-Montserrat">FRONT END WEB DEVELOPER</h1>
          <h2 className="text-slate-100 font-extrabold tracking-wide text-6xl text-center font-Montserrat">FARHAN NAUFAL OTRA</h2>
        ...
        <div className="justify-center flex">
          <img src={photo} alt="" className="justify-center z-10"></img>
        </div>
      </div>
      <div className="w-full overflow-hidden bg-slate-950">
        <Marquee speed={100} autoFill pauseOnHover className="bg-slate-500 text-7xl font-extrabold tracking-wide overflow-hidden font-Montserrat p-4">
          ABOUTMEABOUTME<p className="text-slate-100 shadow-sm">FARHANOTRA</p>ABOUTMEABOUTME
        </Marquee>
        <div className="container pb-32 mx-auto">
          <div className="pt-4 px-4 lg:px-28 justify-center items-center bg-slate-950 flex flex-wrap">
            <motion.div
